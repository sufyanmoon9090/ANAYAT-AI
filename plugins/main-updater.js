...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://github.com/ANAYAT-AI/ANAYAT-AI/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/ANAYAT-AI/ANAYAT-AI/archive/main.zip", { responseType: "arraybuffer" });
